...
class _DeliveryScreenState extends State<DeliveryScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<RiderViewModel>(context, listen: false).getRiderHistoryApi(context);
    });
  }
          ...
          : historyList == null || historyList.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final pickupText = (order.pickupLocation != null && order.pickupLocation!.isNotEmpty)
                        ? "${order.pickupName ?? ''} - ${order.pickupLocation}"
                        : (order.pickupName ?? '');
                    final isDelivered = order.status?.toLowerCase() == 'delivered';
                    final statusColor = isDelivered ? AppColors.mintGreenColor : AppColors.orangeColor;
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (order.productImages != null && order.productImages!.isNotEmpty) ...[
